    ...
    def _send_msg(self, item):
        ...
        if item['case_method'] == 'get':
            ...
            if 'token' in headers:
                ...
                r = requests.get(item['case_url'],params=urlencode(json.loads(item['case_data'])),headers=headers)
    ...
    def _send_msg_data(self, item):
        ...
        if item['case_method'] == 'post':
            ...
            if 'sign' in data:
                ...
                logger().info(item['case_data'])
                r = requests.post(item['case_url'],data=item['case_data'],headers=headers,allow_redirects=False)
            response = r.text
