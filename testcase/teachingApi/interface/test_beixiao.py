...
class TestStatistics(object):
    ...
    getLessonListApp_data = ExcelHandler().get_excel_data_1(file_path,"getTeachingCount")

    @pytest.mark.getTeachingCount
    @pytest.mark.parametrize('item',getLessonListApp_data)
    @allure.feature('查询备课')
    def test_getTeachingCount(self,item,Pname=Pname):
        Iname='getTeachingCount'
        # 获取每一行数并且发请求：
